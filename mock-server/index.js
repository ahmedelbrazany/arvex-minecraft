...
const mockPanel = {
  data: "test-panel-data"
};

// Mock logs
const mockLogs = [
  { text: "Server starting...", date: Date.now() },
  { text: "Loading world...", date: Date.now() + 1000 },
  { text: "Players online: 0", date: Date.now() + 2000 }
];
...
// API endpoints
app.get('/api/v1/deploys/:deployID', (req, res) => {
  res.json(mockServerDetails);
});

app.get('/api/v1/minecraftpanel/:deployID/settings', (req, res) => {
  res.json(mockSettings);
});

app.get('/api/v1/minecraftpanel/:deployID/panel', (req, res) => {
  res.json(mockPanel);
});
